...
public class FXMLController {
    ...
    void corsiPerPeriodo(ActionEvent event) {
    	...
    	//RICORDA SEMPRE DI FARE IL TRY\CATCH. E' MOLTO GRAVE NON FARLO!!!!!
    	try {
    	...
    	//non vanno bene neanche 3 4 5 ... La parseInt non me li ferma quelli
...
//    	}
    	...
    	for(Corso c : corsi) {
    		...
    		//- allineaento a sx, 8 dim max della colonna (corso ha max 8 caratteri), s String, d sta per Intero, % guarda che qui sostituiamo questo con il nome che viene dopo
    		//è tipo il punto interrogativo in DAO, ci vogliono gli spazi tra i get
